...
export default function Studio() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const imageUrl = `http://localhost:5000/generated/${data.image}`;
      ...
      toast.error(err?.response?.data?.error || "Generation failed", {
        duration: err?.response?.status === 429 ? 5000 : 3000,
      });
    }
  };
    ...
    <motion.div
      ...
      <div style={{
        ...
        <motion.div
          ...
          <p style={{ color: "#6b6b8a", marginTop: 10, fontSize: 17 }}>
            Describe your product and let AI do the rest ✦
          </p>
        </motion.div>
        ...
        <div
            ...
            <AnimatePresence mode="wait">
              ...
              {step === "input" && (
                <motion.div
                  ...
                  {/* Product + Audience */}
                  <div className="glass" style={{ borderRadius: 18, padding: 28, marginBottom: 20 }}>
                    <label style={{
                    ...
                    <input
                      ...
                      placeholder='e.g. "Eco Coffee Cup"'
                      value={form.product}
                      onChange={(e) => setForm({ ...form, product: e.target.value })}
                      style={{ marginBottom: 20, fontSize: 15, padding: "14px 16px" }}
                    />
                    <label style={{
                      fontFamily: "Syne", fontWeight: 700, fontSize: 14,
                      color: "#a78bfa", letterSpacing: 1, textTransform: "uppercase",
                      ...
                      {TONES.map((t) => (
                        <button
                          ...
                          style={{
                            ...
                            border: `2px solid ${form.tone === t ? "#7c3aed" : "rgba(124,58,237,0.2)"}`,
                            background: form.tone === t ? "rgba(124,58,237,0.2)" : "transparent",
                            color: form.tone === t ? "#e879f9" : "#6b6b8a",
                          ...
                          <span style={{ fontSize: 22 }}>{toneEmojis[t]}</span>
                          {t}
                        </button>
                      ))}
                    </div>
                  ...
                  <div className="glass" style={{ borderRadius: 18, padding: 24, marginBottom: 20 }}>
                    ...
                    <label style={{
                      ...
                      border: "2px dashed rgba(124,58,237,0.4)", borderRadius: 12,
                      padding: "18px 20px",
                    }}>
              ...
              {step === "generating" && (
                <motion.div
                  ...
                  <h3 style={{ fontFamily: "Syne", fontSize: 26, marginBottom: 14, fontWeight: 800 }}>
                    Generating your ad...
                  </h3>
                  <p style={{ color: "#6b6b8a", marginBottom: 32, fontSize: 16 }}>
                    AI is crafting your image, copy, and hashtags
                  </p>

                  <div style={{
                    background: "rgba(124,58,237,0.15)", borderRadius: 100,
                    height: 10, overflow: "hidden", maxWidth: 340, margin: "0 auto",
                  }}>
                    <motion.div
                  ...
                  <p style={{ color: "#a78bfa", marginTop: 12, fontSize: 15 }}>
                    {Math.round(progress)}%
                  </p>

                  <div style={{
                    display: "flex", flexDirection: "column", gap: 10,
                    marginTop: 28, fontSize: 15, color: "#6b6b8a",
                  }}>
                    {[
                      "Rewriting prompt with AI...",
                      "Generating image...",
                      "Writing caption...",
                      "Saving to database...",
                    ].map((s, i) => (
                      <div key={s} style={{
                        ...
                        <span style={{ color: progress > i * 25 ? "#10b981" : "#6b6b8a", fontSize: 16 }}>
                          {progress > i * 25 ? "✓" : "○"}
                        </span>
                        {s}
                      </div>
              ...
              {step === "result" && result && (
                <motion.div
                  ...
                  <div className="glass" style={{ borderRadius: 18, padding: 28, marginBottom: 16 }}>
                    ...
                    <p style={{
                      color: "#f0e6ff", fontFamily: "Syne",
                      fontWeight: 800, fontSize: 22, lineHeight: 1.3,
                    }}>{result.headline}</p>
                  </div>
          ...
          {/* ── RIGHT PANEL: Canvas always mounted ── */}
          <div
            className="canvas-preview-sticky"
            style={{ position: "sticky", top: 100 }}>

            <h3 style={{
              fontFamily: "Syne", fontWeight: 700, fontSize: 18,
              color: "#a78bfa", marginBottom: 18,
            ...
            <div style={{ position: "relative" }}>
              ...
              {/* Placeholder overlay — only shown before first generate */}
              {step === "input" && !result && (
                <div style={{
                  ...
                  <p style={{ fontSize: 14, color: "#4b4b6a", marginTop: 8 }}>
